...
from .views import index, register_request, user_page, your_page, users_page, ratings_page, edit_user_page, settings_page
...
urlpatterns = [
    ...
    path('users/you/settings', settings_page, name='settings_page'),
